        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Flutter Apps with Modern UI</h4>
              <p>
                Designing and building cross-platform mobile apps in Flutter
                with smooth UI, responsive layouts and a focus on performance
                and user experience.
              </p>
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Firebase (basic)</div>
              </div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Building secure, scalable backends and REST APIs using Python,
                Django and Flask. I focus on clean architecture, database
                design, and integrations that make apps fast and reliable.
              </p>
              <h5>Skillset &amp; tools</h5>
              <div className="what-content-flex">
